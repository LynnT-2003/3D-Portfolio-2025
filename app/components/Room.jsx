...
const Room = (props) => {
  const { nodes, materials } = useGLTF("/models/chill-room.glb");
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[-3.781, 2.47, -1.132]} scale={1.456}>
        <mesh geometry={nodes.Object_33.geometry} material={materials.screen} />
      ...
      <group position={[-2.793, 1.422, -2.237]} scale={[0.137, 0.04, 0.083]}>
        ...
        <mesh geometry={nodes.Object_37.geometry} material={materials.negro} />
      </group>
...
useGLTF.preload("/models/chill-room.glb");
